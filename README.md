...
/*
implementing mergeSort (redone perfectly without a problem)
input:  4
        8 5 6 90
output: 5 6 8 90 
*/    
...
/* 
implementing the buble sort (without even lookin)
*/
...
/*
implement selection sort (redone without even looking)
*/
...
/*
implement insertSort (done with logic)
*/    
import java.util.*;
public class kd{
    public static void main(String args[]){
